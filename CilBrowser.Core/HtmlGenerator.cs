...
namespace CilBrowser.Core
{
    public class HtmlGenerator
    {
        ...
        public HtmlGenerator(Assembly ass, string ns)
        {
        ...
        /// </summary>
        public static void GenerateWebsite(Assembly ass, string nsFilter, string outputPath)
        {
            HtmlGenerator generator = new HtmlGenerator(ass, nsFilter);
