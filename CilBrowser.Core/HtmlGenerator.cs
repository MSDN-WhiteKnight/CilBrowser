...
namespace CilBrowser.Core
{
    ...
    public class HtmlGenerator
    {
        ...
        static SyntaxNode[] GetTokens(string content, string ext)
        {
            ...
            else if (Utils.StrEquals(ext, ".xml") || Utils.StrEquals(ext, ".csproj")
                || Utils.StrEquals(ext, ".vbproj") || Utils.StrEquals(ext, ".vcxproj")
                || Utils.StrEquals(ext, ".proj") || Utils.StrEquals(ext, ".ilproj")
                || Utils.StrEquals(ext, ".htm") || Utils.StrEquals(ext, ".html") 
                || Utils.StrEquals(ext, ".config") || Utils.StrEquals(ext, ".xaml"))
            {
                return TokenParser.ParseTokens(content, s_markupDefinitions,
                    new MarkupClassifier());
            }
            else
            {
                return TokenParser.ParseTokens(content, TokenParser.GetDefinitions(ext),
