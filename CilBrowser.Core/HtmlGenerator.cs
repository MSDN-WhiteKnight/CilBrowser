...
namespace CilBrowser.Core
{
    ...
    public class HtmlGenerator
    {
        ...
        internal const string AppName = ".NET CIL Browser";
        ...
        {
            AssemblyName an = ass.GetName();
            toc.StartDocument(AppName + " - " + an.Name, GlobalStyles);
            toc.WriteParagraph(AppName);
        ...
        {
            toc.StartDocument(AppName + " - " + title, GlobalStyles);
            toc.WriteParagraph(AppName);
