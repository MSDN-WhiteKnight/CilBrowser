...
namespace CilBrowser.Core
{
    ...
    public class HtmlGenerator
    {
        ...
        /// <summary>
        /// Generates HTML markup to visualize the specified source text with syntax highlighting
        /// </summary>
        /// <param name="sourceText">Source text to visualize</param>
        /// <param name="ext">
        ...
        public static void VisualizeSourceText(string sourceText, string ext, TextWriter target)
        {
        ...
        /// <see cref="VisualizeSourceText"/> method.
        /// </summary>
